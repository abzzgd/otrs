...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'The full path and name of the SSL client certificate file (must be in PEM, DER or PKCS#12 format).' =>
            '',
        'e.g. /usr/local/otrs/var/certificates/SOAP/certificate.pem' => 'например /usr/local/otrs/var/certificates/SOAP/certificate.pem',
        'Client Certificate Key' => 'Ключ сертификата клиента',
        'The full path and name of the SSL client certificate key file (if not already included in certificate file).' =>
            '',
        'e.g. /usr/local/otrs/var/certificates/SOAP/key.pem' => 'например /usr/local/otrs/var/certificates/SOAP/key.pem',
        ...
        'e.g. /usr/local/otrs/var/certificates/SOAP/CA/ca.pem' => 'например, /usr/local/otrs/var/certificates/SOAP/CA/ca.pem',
        ...
        'e.g. /usr/local/otrs/var/certificates/SOAP/CA' => 'например, /usr/local/otrs/var/certificates/SOAP/CA',
...
',
        ...
        'Defines the path to open ssl binary. It may need a HOME env ($ENV{HOME} = \'/var/lib/www\';).' =>
            'Задает путь к ssl binary. Может понадобиться переменная HOME - ($ENV{HOME} = \'/var/lib/www\';).',
