...
sub Data {
    ...
    $Self->{Completeness}        = 0.654395320832617;
...
"CustomerGroupCompanyAlwaysGroups".',
        ...
        'Filter for Generic Agent Jobs' => 'Filtr zadań agenta automatycznego',
        'Filter for generic agent jobs' => 'Filtr zadań agenta automatycznego',
        ...
        'e.g. /usr/local/otrs/var/certificates/SOAP/certificate.pem' => 'np. /usr/local/otrs/var/certificates/SOAP/certificate.pem',
        ...
        'e.g. /usr/local/otrs/var/certificates/SOAP/key.pem' => 'np. /usr/local/otrs/var/certificates/SOAP/key.pem',
        ...
        'e.g. /usr/local/otrs/var/certificates/SOAP/CA/ca.pem' => 'np. /usr/local/otrs/var/certificates/SOAP/CA/ca.pem',
        ...
        'e.g. /usr/local/otrs/var/certificates/SOAP/CA' => 'np. /usr/local/otrs/var/certificates/SOAP/CA',
        ...
        'Service name maximum length is 200 characters (with Sub-service).' =>
            'Długość nazwy serwisów to maksymalnie 200 znaków (razem z pod-serwisem)',
...
' => '',
        ...
        'Defines the path to open ssl binary. It may need a HOME env ($ENV{HOME} = \'/var/lib/www\';).' =>
            'Definiuje ścieźkę do programu ssl. Może wymagać środowiska HOME ($ENV{HOME} = \'/var/lib/www\';).',
