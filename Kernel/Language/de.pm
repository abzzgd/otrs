...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'e.g. /usr/local/otrs/var/certificates/SOAP/certificate.pem' => 'z.B. /usr/local/otrs/var/certificates/SOAP/certificate.pem',
        ...
        'e.g. /usr/local/otrs/var/certificates/SOAP/key.pem' => 'z.B. /usr/local/otrs/var/certificates/SOAP/key.pem',
        ...
        'e.g. /usr/local/otrs/var/certificates/SOAP/CA/ca.pem' => 'z. B. /usr/local/otrs/var/certificates/SOAP/CA/ca.pem',
        ...
        'e.g. /usr/local/otrs/var/certificates/SOAP/CA' => 'z. B. /usr/local/otrs/var/certificates/SOAP/CA',
...
',
        ...
        'Defines the path to open ssl binary. It may need a HOME env ($ENV{HOME} = \'/var/lib/www\';).' =>
            'Legt den Pfad zum OpenSSL-Binary fest. Es benötigt möglicherweise ein HOME-Env ($ENV{HOME} = \'/var/lib/www\';).',
