...
sub Data {
    ...
    $Self->{Completeness}        = 0.481334938929985;
    ...
    $Self->{Translation} = {
        ...
        'The full path and name of the SSL client certificate key file (if not already included in certificate file).' =>
            '',
        'e.g. /usr/local/otrs/var/certificates/SOAP/key.pem' => 'ad es. /usr/local/otrs/var/certificates/SOAP/key.pem',
        ...
        'e.g. /usr/local/otrs/var/certificates/SOAP/CA/ca.pem' => 'es. /usr/local/otrs/var/certificates/SOAP/CA/ca.pem',
        ...
        'e.g. /usr/local/otrs/var/certificates/SOAP/CA' => 'es. /usr/local/otrs/var/certificates/SOAP/CA',
