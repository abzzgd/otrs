...
sub Data {
    ...
    $Self->{Completeness}        = 0.402373989334251;
    ...
    $Self->{Translation} = {
        ...
        'e.g. /usr/local/otrs/var/certificates/SOAP/CA/ca.pem' => 'f.eks. /usr/local/otrs/var/certificates/SOAP/CA/ca.pem',
        ...
        'e.g. /usr/local/otrs/var/certificates/SOAP/CA' => 'f.eks. /usr/local/otrs/var/certificates/SOAP/CA',
