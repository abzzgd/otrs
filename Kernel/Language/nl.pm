...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'Edit Customer' => 'Bedrijf bewerken',
        'Search' => 'Zoeken',
        ...
        'Please note' => 'Let op',
        'This customer backend is read only!' => 'Deze bedrijven backend is read only!',
        ...
        'Edit Customer Default Groups' => 'Bewerk standaard groepen voor bedrijven',
        ...
        'Customers' => 'Bedrijven',
        'Groups' => 'Groepen',
        'Change Group Relations for Customer' => 'Bewerk gekoppelde groepen voor bedrijf',
        'Change Customer Relations for Group' => 'Bewerk gekoppelde bedrijven voor groep',
        ...
        'This CustomerID is invalid.' => 'Dit CustomerID (bedrijf) is ongeldig.',
        ...
        'Customer' => 'Klant',
        'This customer user has no customer access.' => 'Deze klant heeft geen toegang vanuit het bedrijf.',
        ...
        'e.g. /usr/local/otrs/var/certificates/SOAP/CA/ca.pem' => 'Bijvoorbeeld /usr/local/otrs/var/certificates/SOAP/CA/ca.pem',
        ...
        'e.g. /usr/local/otrs/var/certificates/SOAP/CA' => 'bijvoorbeeld /usr/local/otrs/var/certificates/SOAP/CA',
        ...
        'Manage %s' => 'Beheer %s',
        'Downgrade to OTRS Free' => 'Downgrade naar OTRS Free',
        ...
        'Your OTRS Free is the base for all future actions. Please register first before you continue with the upgrade process of %s!' =>
            'Jouw gratis OTRS is de basis voor alle toekomstige acties. Registreer eerst voordat je verder gaat met het upgrade proces van %s.',
        ...
        'You are about to downgrade to OTRS Free and will lose the following features and all data related to these:' =>
            'Je staat op het punt om te downgraden naar OTRS Free en verliest de volgende features en alle gegevens die daaraan gerelateerd zijn:',
        'Chat' => 'Chat',
        ...
        'Error Log' => 'Fouten logboek',
        'There are error reports in your system log.' => 'Er staat fout rapportages in het logbestand system.log.',
