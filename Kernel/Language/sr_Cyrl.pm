...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'e.g. /usr/local/otrs/var/certificates/SOAP/certificate.pem' => 'нпр. /usr/local/otrs/var/certificates/SOAP/certificate.pem',
        ...
        'e.g. /usr/local/otrs/var/certificates/SOAP/key.pem' => 'нпр. /usr/local/otrs/var/certificates/SOAP/key.pem',
        ...
        'e.g. /usr/local/otrs/var/certificates/SOAP/CA/ca.pem' => 'нпр. /usr/local/otrs/var/certificates/SOAP/CA/ca.pem',
        ...
        'e.g. /usr/local/otrs/var/certificates/SOAP/CA' => 'нпр. /usr/local/otrs/var/certificates/SOAP/CA',
...
',
        ...
        'Defines the path to open ssl binary. It may need a HOME env ($ENV{HOME} = \'/var/lib/www\';).' =>
            'Одређује путању до open ssl апликације. Може бити неопходна HOME варијабла ($ENV{HOME} = \'/var/lib/www\';).',
