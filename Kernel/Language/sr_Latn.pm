...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'e.g. /usr/local/otrs/var/certificates/SOAP/certificate.pem' => 'npr. /usr/local/otrs/var/certificates/SOAP/certificate.pem',
        ...
        'e.g. /usr/local/otrs/var/certificates/SOAP/key.pem' => 'npr. /usr/local/otrs/var/certificates/SOAP/key.pem',
        ...
        'e.g. /usr/local/otrs/var/certificates/SOAP/CA/ca.pem' => 'npr. /usr/local/otrs/var/certificates/SOAP/CA/ca.pem',
        ...
        'e.g. /usr/local/otrs/var/certificates/SOAP/CA' => 'npr. /usr/local/otrs/var/certificates/SOAP/CA',
...
',
        ...
        'Defines the path to open ssl binary. It may need a HOME env ($ENV{HOME} = \'/var/lib/www\';).' =>
            'Određuje putanju do open ssl aplikacije. Može biti neophodna HOME varijabla ($ENV{HOME} = \'/var/lib/www\';).',
