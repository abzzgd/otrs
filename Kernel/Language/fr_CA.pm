...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'e.g. /usr/local/otrs/var/certificates/SOAP/CA/ca.pem' => 'par ex. /usr/local/otrs/var/certificates/SOAP/CA/ca.pem',
        ...
        'e.g. /usr/local/otrs/var/certificates/SOAP/CA' => 'par ex. /usr/local/otrs/var/certificates/SOAP/CA',
...
' => '',
        ...
        'Defines the path to open ssl binary. It may need a HOME env ($ENV{HOME} = \'/var/lib/www\';).' =>
            'Détermine le chemin vers le code binaire du protocole ouvert ssl. Une variable d\'environnement HOME peut être nécessaire ($ENV{HOME} = \'/var/lib/www\';).',
