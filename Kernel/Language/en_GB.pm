...
sub Data {
    ...
    $Self->{Completeness}        = 0.692929640461036;
    ...
    $Self->{Translation} = {
        ...
        'The full path and name of the certification authority certificate file that validates SSL certificate.' =>
            'The full path and name of the certification authority certificate file that validates SSL certificate.',
        'e.g. /usr/local/otrs/var/certificates/SOAP/CA/ca.pem' => 'e.g. /usr/local/otrs/var/certificates/SOAP/CA/ca.pem',
        'Certification Authority (CA) Directory' => 'Certification Authority (CA) Directory',
        'The full path of the certification authority directory where the CA certificates are stored in the file system.' =>
            'The full path of the certification authority directory where the CA certificates are stored in the file system.',
        'e.g. /usr/local/otrs/var/certificates/SOAP/CA' => 'e.g. /usr/local/otrs/var/certificates/SOAP/CA',
