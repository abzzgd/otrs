...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'Customer ID' => '顧客ID',
        'Please note' => '注意',
        'This customer backend is read only!' => 'この顧客のバックエンドは読み取り専用です！',
        ...
        'Manage Customer User-Services Relations' => '顧客とサービスの関係を管理',
        ...
        'Add job' => 'ジョブ追加',
        'Run job' => 'ジョブ実行',
        'Filter for Generic Agent Jobs' => '管理用ジョブでフィルター',
        'Filter for generic agent jobs' => '管理用ジョブでフィルター',
        'Last run' => '最終実行',
        'Run Now!' => '今すぐ実行！',
        ...
        'The full path and name of the SSL client certificate file (must be in PEM, DER or PKCS#12 format).' =>
            '',
        'e.g. /usr/local/otrs/var/certificates/SOAP/certificate.pem' => '例 /usr/local/otrs/var/certificates/SOAP/certificate.pem',
        'Client Certificate Key' => 'クライアント認証キー',
        'The full path and name of the SSL client certificate key file (if not already included in certificate file).' =>
            '',
        'e.g. /usr/local/otrs/var/certificates/SOAP/key.pem' => '例 /usr/local/otrs/var/certificates/SOAP/key.pem',
        ...
        'The full path and name of the certification authority certificate file that validates SSL certificate.' =>
            '',
        'e.g. /usr/local/otrs/var/certificates/SOAP/CA/ca.pem' => '例… /usr/local/otrs/var/certificates/SOAP/CA/ca.pem',
        'Certification Authority (CA) Directory' => '',
        'The full path of the certification authority directory where the CA certificates are stored in the file system.' =>
            '',
        'e.g. /usr/local/otrs/var/certificates/SOAP/CA' => '例… /usr/local/otrs/var/certificates/SOAP/CA',
...
OTRSが443ポートを用いてcloud.otrs.comに接続できることを確認して下さい。',
        ...
        'Add filter' => 'フィルターの追加',
        'Filter for Postmaster Filters' => 'ポストマスター・フィルターでフィルター',
        'Filter for postmaster filters' => 'ポストマスター・フィルターでフィルター',
...
\'Search_DynamicField_XTimeSlotStartYear=1974; Search_DynamicField_XTimeSlotStartMonth=01; Search_DynamicField_XTimeSlotStartDay=26; Search_DynamicField_XTimeSlotStartHour=00; Search_DynamicField_XTimeSlotStartMinute=00; Search_DynamicField_XTimeSlotStartSecond=00; Search_DynamicField_XTimeSlotStopYear=2013; Search_DynamicField_XTimeSlotStopMonth=01; Search_DynamicField_XTimeSlotStopDay=26; Search_DynamicField_XTimeSlotStopHour=23; Search_DynamicField_XTimeSlotStopMinute=59; Search_DynamicField_XTimeSlotStopSecond=59;\' and or \'Search_DynamicField_XTimePointFormat=week; Search_DynamicField_XTimePointStart=Before; Search_DynamicField_XTimePointValue=7\';',
        ...
        'Defines the path to open ssl binary. It may need a HOME env ($ENV{HOME} = \'/var/lib/www\';).' =>
            'sslバイナリを開くためのパスを定義します。HOME env ($ENV{HOME} = \'/var/lib/www\';).が必要になるかもしれません。',
        ...
        'Dynamic fields shown in the ticket preview format overview screen of the agent interface.' =>
            '担当者インターフェイスのチケットプレビュー形式の一覧画面に表示される動的なフィールド',
...
（例：From / \'(.+?)@.+?\'とし、「Set」にて「[***]」として後方参照を使用します。）',
        ...
        'Started solution time escalation.' => 'ソリューション時間のエスカレーションを開始しました。',
