...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'e.g. /usr/local/otrs/var/certificates/SOAP/CA/ca.pem' => 'наприклад /usr/local/otrs/var/certificates/SOAP/CA/ca.pem',
        ...
        'e.g. /usr/local/otrs/var/certificates/SOAP/CA' => 'наприклад /usr/local/otrs/var/certificates/SOAP/CA',
